...
import Cliente.ClientePoupanca;
...
public class LoginPoupancaC {
    ...
    public static void exibirTelaLogin() {
        ...
        loginCorrenteC.GradientPanel gradientPanel = new loginCorrenteC.GradientPanel();
        ...
        btnEntrar.addActionListener(e -> {
            ...
            if (usuarios.containsKey(cpf) && usuarios.get(cpf).equals(senha)) {
                ...
                ClientePoupanca.exibirMenu(); // Abre o menu ClienteCorrente
            } else {
